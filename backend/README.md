...
## Project Structure
    ...
    ├── weathered_firefly_d_81430  # Django project configurations
...
1. Clone this repo and `cd weathered_firefly_d_81430`
...
2. Clone this repo and `cd weathered_firefly_d_81430`
